  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 lg:py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
        <div className="relative aspect-square rounded-xl overflow-hidden bg-stucco shadow-[var(--shadow-medium)]">
          <Image
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
        {values.map((item) => (
          ...
          >
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-peach-soft/30 mb-4">
              <item.icon className="w-7 h-7 text-apricot-deep" strokeWidth={1.6} />
            </div>
      ...
      <div id="contact" className="mb-16 scroll-mt-24">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-muted">We&apos;d love to hear from you!</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {contactInfo.map((item) => (
            ...
            >
              <item.icon className="w-6 h-6 text-apricot-deep mx-auto mb-3" strokeWidth={1.6} />
              <p className="text-xs text-ink-subtle uppercase tracking-wide mb-1">{item.label}</p>
              {item.href ? (
      ...
      <div id="shipping" className="scroll-mt-24">
        <div className="bg-stucco/50 rounded-xl p-8 border border-apricot-deep/10">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <div className="w-10 h-10 rounded-full bg-apricot-deep/10 flex items-center justify-center">
                <Truck className="w-5 h-5 text-apricot-deep" strokeWidth={1.6} />
              </div>
            </div>
            <div>
              ...
              <div className="prose-boutique prose prose-sm text-ink-muted max-w-none space-y-3">
                <p>
