  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 lg:py-20">
      ...
      <div className="prose prose-sm max-w-none text-ink-muted space-y-8">
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">3. Local Storage & Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">4. Third-Party Services</h2>
          <p>We use the following third-party services that may collect data:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Shopify:</strong> Our e-commerce platform that processes orders and payments. See <a href="https://www.shopify.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-apricot-deep hover:text-apricot-deep/80">Shopify&apos;s Privacy Policy</a>.</li>
            ...
            <li><strong>Vercel:</strong> Our website hosting provider. See <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-apricot-deep hover:text-apricot-deep/80">Vercel&apos;s Privacy Policy</a>.</li>
          </ul>
        </section>

        <section>
          <h2 className="font-serif text-xl text-ink">5. Data Sharing</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">6. Data Security</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">7. Your Rights</h2>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">8. Children&apos;s Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">9. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">10. Contact Us</h2>
          <p>
