  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 lg:py-20">
      <div className="text-center mb-12">
        ...
        <p className="text-ink-muted">Everything you need to know about getting your order to you.</p>
        ...
        {shippingMethods.map((method) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-peach-soft/30 flex items-center justify-center">
                <method.icon className="w-5 h-5 text-apricot-deep" strokeWidth={1.6} />
              </div>
              <h3 className="font-serif text-lg text-ink">{method.title}</h3>
            </div>
            <p className="text-sm text-ink-muted mb-1">{method.time}</p>
            <p className="text-sm font-medium text-apricot-deep">{method.cost}</p>
          </div>
        ))}
      </div>
      ...
      <div className="prose prose-sm max-w-none text-ink-muted space-y-8">
        <section>
          <h2 className="font-serif text-xl text-ink">Processing Time</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">Order Tracking</h2>
          <p>
            ...
            <a href="/account" className="text-apricot-deep hover:text-apricot-deep/80">order history</a>.
          </p>
        </section>

        <section>
          <h2 className="font-serif text-xl text-ink">Free Shipping</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">International Orders</h2>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">Shipping Delays</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif text-xl text-ink">Lost or Damaged Packages</h2>
          <p>
